...
namespace Boxer.Managemt.Product.api.Controllers
{
    ...
    public class UserAccountsController : ControllerBase
    {
        ...
        public UserAccountsController(DatabaseContext context, IConfiguration config, PasswordService passwordservice)
        {
            _context = context;
            appConfig = config;
        ...
        public async Task<ActionResult<String>> PostUserAccount(UserAccount userAccount)
        {
            try
            {
                ...
                await _context.SaveChangesAsync();
                loginDto loginDto = new loginDto(GenerateJWTToken(userAccount));
